        ...
        if(isset($_GET['id'])){
            ...
            if($buy>=$sell){
                if(isset($_POST['Submit'])){
                    ...
                    $cssq= "UPDATE customer_info SET quantity= '$sell', product_id = '$id', payment = '$pay' WHERE customer_id = '$cid'";
                    if($conn->query($sql) === true && $conn->query($cssq) === true){
                ...
                <div class="row pt-20" >
                    ...
                    <div class="col-sm-7" >
                        <form method="POST" action="send.php">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <label class="pull-right"><h2>Customer ID:</h2></label>
                                </div>
                                <div class="col-sm-6 form-input pt-10">
                                    <input type="text" name="customerid" value="customerid" placeholder="Customer ID">
                                </div>
                            </div>

                            <div class="row">
                                <div class="col-sm-6">
                                    <label class="pull-right"><h2>Payment:</h2></label>
                                </div>
                                <div class="col-sm-6 form-input pt-10">
                                    <input type="text" name="payment" value="payment" placeholder="Payment">
                                </div>
                            </div>
